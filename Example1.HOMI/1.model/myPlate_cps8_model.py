'''
-------------------------------------------------------------------------------
 Mixed-mode crack in a homogeneous plate modeled using
...
aa = 33                                   # height of the crack-tip

# Material
E0 = 280                                  # Young's modulus
...
myViewport = session.Viewport(name=mymodelName)
...
plateMaterialName = 'LinearElastic'
umatMatl = myModel.Material(name=plateMaterialName)
umatMatl.Elastic(table=((E0, xnu), ))
...
myModel.DisplacementBC(name='bottomFixed', createStepName=myStepName,
...
myModel.DisplacementBC(name='rightFixed', createStepName=myStepName,
